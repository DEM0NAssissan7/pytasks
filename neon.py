...
Task("Remove snap", "apt autoremove snapd", selected=True)
...
Task("Command Not Found (enhancement)","""
            ...
            apt update
            """, selected=True)
Task("Pipewire w/ Wireplumber (replaces Pulse Audio)", """
            apt install pipewire-pulse wireplumber pipewire-jack
            apt autoremove pulseaudio
...
Task("VLC (app)",
            "apt install vlc")
Task("mpv (removes VLC)",
            "apt install mpv && apt autoremove vlc",
            selected=True)
